...
- `rules/koog-for-agents.md` now states the JDK floor explicitly — Koog 1.0 raised minimum JDK from previously-implicit-21 to **JDK 17 minimum** (JDK 21 still recommended for parity with JavaCV 1.5.13 native libs)
